...
class MinimalPooblisher(Node):
    ...
    def __init__(self):
        ...
        # Initialize publisher to publish String messages to the topic "/tawpic".
        # 10 is the queue size, don't worry about it
        self.publisher_ = self.create_publisher(String, 'tawpic', 10)
...
def main(args=None):
    ...
    minimal_publisher = MinimalPawblisher()
